...
public partial class VezeetaContext : DbContext
{
    ...
    //        => optionsBuilder.UseSqlServer("Data Source=.\\SQLexpress;Initial Catalog=VezeetaDB;Integrated Security=True;Trust Server Certificate=True;Command Timeout=300");
